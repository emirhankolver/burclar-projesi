...
public class HoroscopeSagittarius implements Horoscope {
    @Override
    ...
    public int getDrawableId() {
        return R.drawable.sagittarius200;
    }
    ...
    public static final Creator<Horoscope> CREATOR = new Creator<Horoscope>() {
        ...
        public Horoscope createFromParcel(Parcel in) {
            return new HoroscopeSagittarius();
        }

        @Override
        public Horoscope[] newArray(int size) {
            return new HoroscopeSagittarius[size];
        }
    };
}
